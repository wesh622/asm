...
Examen d'Assembleur ARM 32 bits - Conso - 2024-2025 / durée : 1h30
...
Dans une architecture ARM 32 bits, la taille d’un octet est de :
- 1 bit
- 8 bits
- 32 bits
- 2 puissance 32 bits
- Ca dépend du contenu de l'octet
...
En considérant les 2 erreurs comme corrigées, et en suivant le formalisme de la pile déjà vu en TD et commencée dans le fichier reponse, complétez (et modifiez si besoin) le schéma de la pile **juste avant** l'execution de la ligne 77 (label *FINAL*) du fichier ASM.
